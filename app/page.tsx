...
export default function Home() {
  return (
    // CAMBIO GLOBAL: Usamos un fondo muy sutilmente azulado en lugar de blanco puro para dar sensación premium
    <main className="min-h-screen bg-[#F8FAFC] text-slate-600 font-sans selection:bg-teal-100 selection:text-indigo-900 scroll-smooth">
      
      {/* --- NAVBAR --- */}
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-indigo-50 shadow-sm transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            {/* MENU CON COLOR NAVY (AZUL MARINO) */}
            <div className="hidden md:flex items-center gap-8 font-medium text-indigo-900/80 text-sm">
              <Link href="/browse" className="hover:text-teal-500 transition-colors">Find Tutors</Link>
              ...
              <a href="#maestros" className="hover:text-teal-500 transition-colors">Soy Maestro</a>
              <a href="#faq" className="hover:text-teal-500 transition-colors">FAQ</a>
            </div>

            <div className="flex items-center gap-4">
              <Link href="/login" className="hidden sm:inline-flex px-5 py-2.5 text-indigo-900 font-bold hover:text-teal-600 transition-colors">
                Log in
              </Link>
              {/* BOTÓN CON EL COLOR EXACTO DEL LOGO (INDIGO) */}
              <Link href="/register" className="inline-flex items-center gap-2 px-6 py-3 bg-[#1e1b4b] text-white rounded-full font-bold hover:bg-teal-500 transition-all shadow-lg hover:shadow-teal-500/20 hover:-translate-y-0.5">
                Get Started
              </Link>
            </div>
          </div>
      ...
      <section className="pt-36 pb-20 lg:pt-48 lg:pb-32 relative overflow-hidden">
         {/* Fondo sutil con los colores del logo */}
         <div className="absolute top-0 right-0 -z-10 opacity-30">
            <div className="w-[600px] h-[600px] bg-teal-100 rounded-full blur-[100px] absolute -top-20 -right-20"></div>
            <div className="w-[500px] h-[500px] bg-indigo-100 rounded-full blur-[100px] absolute top-40 right-40"></div>
         </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-800 text-xs font-bold uppercase tracking-wider mb-8">
                <span className="w-2 h-2 rounded-full bg-teal-400 animate-pulse"></span>
                New: Integrated Digital Wallet
              </div>
              
              {/* TITULO CON EL COLOR NAVY DEL LOGO */}
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6 text-[#1e1b4b]">
                Learn Spanish <br/>
                {/* GRADIENTE DE LA MARCA: INDIGO A MENTA */}
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Link href="/register" className="flex items-center justify-center gap-3 px-8 py-4 bg-[#1e1b4b] text-white rounded-2xl font-bold text-lg hover:bg-indigo-800 transition-all shadow-xl shadow-indigo-200">
                  Find a Tutor
                  <ArrowRight className="w-5 h-5" />
                </Link>
                <a href="#how-it-works" className="flex items-center justify-center gap-3 px-8 py-4 bg-white text-indigo-900 border-2 border-indigo-50 rounded-2xl font-bold text-lg hover:border-teal-500 hover:text-teal-600 transition-all">
            ...
            <div className="relative mx-auto w-full max-w-[600px]">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl border border-slate-100 flex items-center gap-3 animate-bounce-slow">
                 <div className="bg-teal-50 p-2 rounded-full"><CheckCircle className="w-6 h-6 text-teal-500"/></div>
                 <div>
                    <p className="text-xs text-slate-500 font-bold uppercase">Certified</p>
                    <p className="font-bold text-indigo-900">Native Speakers</p>
                 </div>
              </div>
            </div>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-20">
                <h2 className="text-teal-500 font-bold tracking-wide uppercase mb-4">Why Choose Tutorio?</h2>
                <p className="text-4xl font-extrabold text-[#1e1b4b]">Everything you need to become fluent.</p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
                <div className="flex-1 order-2 md:order-1">
                    ...
                    <h3 className="text-3xl font-bold text-[#1e1b4b] mb-4">Interactive Video Classroom</h3>
                    <p className="text-lg text-slate-600 leading-relaxed mb-6">
                        No need to install Zoom or Skype. Our classroom runs directly in your browser. It features:
                    </p>
                    <ul className="space-y-3">
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> HD Video & Audio</li>
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Screen Sharing & Whiteboard</li>
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Chat with instant translation</li>
                    </ul>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
                ...
                <div className="flex-1">
                    ...
                    <h3 className="text-3xl font-bold text-[#1e1b4b] mb-4">Pay Per Lesson, Not Subscriptions</h3>
                    <p className="text-lg text-slate-600 leading-relaxed mb-6">
                        We believe in freedom. Load your wallet and pay only for the classes you book.
                    </p>
                    <ul className="space-y-3">
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Secure Wallet System</li>
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Transparent Pricing (Set by Tutors)</li>
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Money-back guarantee on cancellations</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1 order-2 md:order-1">
                    ...
                    <h3 className="text-3xl font-bold text-[#1e1b4b] mb-4">Smart Scheduling</h3>
                    <p className="text-lg text-slate-600 leading-relaxed mb-6">
                        Booking a class is as easy as one click. We handle the time-zone math so you don't have to.
                    </p>
                    <ul className="space-y-3">
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Auto Time-zone Conversion</li>
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Instant Calendar Sync</li>
                        <li className="flex items-center gap-3 text-slate-700 font-medium"><CheckCircle className="w-5 h-5 text-teal-500"/> Reminders before class</li>
                    </ul>
                </div>
                <div className="flex-1 order-1 md:order-2">
      ...
      <section id="how-it-works" className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-extrabold text-[#1e1b4b]">Start Speaking in 3 Steps</h2>
      ...
      <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              {/* FONDO OSCURO DEL COLOR CORPORATIVO */}
              <div className="grid md:grid-cols-2 gap-12 items-center bg-[#1e1b4b] rounded-[3rem] p-12 text-white relative overflow-hidden">
      ...
      <section id="maestros" className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Texto de Venta */}
            <div>
              <span className="text-teal-600 font-bold tracking-wider uppercase text-sm">Para Profesores</span>
              <h2 className="text-4xl font-extrabold mt-2 mb-6 text-[#1e1b4b] leading-tight">
              ...
              <Link href="/register?role=teacher" className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-indigo-600 border border-transparent rounded-full hover:bg-indigo-800 shadow-lg hover:shadow-indigo-500/30">
            ...
            <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-600 to-teal-400 rounded-3xl transform rotate-3 opacity-10"></div>
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 relative">
                    <div className="flex items-center gap-4 mb-6 border-b border-slate-50 pb-6">
                        ...
                        <div>
                            <h3 className="font-bold text-lg text-[#1e1b4b]">Carlos Mendoza</h3>
                            <p className="text-teal-600 text-sm font-medium">Profesor de Español</p>
                        </div>
                        <div className="ml-auto text-right">
                            <p className="text-2xl font-bold text-[#1e1b4b]">$25<span className="text-sm font-normal text-slate-400">/h</span></p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 flex justify-between items-center text-sm font-bold text-slate-600">
                        ...
                        <span className="text-teal-600 flex items-center gap-1"><CheckCircle className="w-4 h-4"/> Verificado</span>
                    </div>
                </div>
            </div>
      ...
      <section id="faq" className="py-24 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-extrabold text-center text-[#1e1b4b] mb-12">Frequently Asked Questions</h2>
              <div className="space-y-4">
                  {[
                      ...
                      <div key={i} className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                          <h3 className="font-bold text-lg text-[#1e1b4b] mb-2 flex justify-between items-center">
                              {item.q}
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-extrabold text-[#1e1b4b] mb-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/register" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#1e1b4b] text-white rounded-full font-bold text-lg hover:bg-indigo-800 transition-all shadow-xl">
                Create Free Account
            </Link>
